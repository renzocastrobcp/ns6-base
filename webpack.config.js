...
module.exports = env => {
    ...
    const config = {
                ...
                cacheGroups: {
                    vendor: {
                        ...
                        test: (module, chunks) => {
                          ...
                          return (
                            (/[\\/]node_modules[\\/]/.test(moduleName) && !/[\\/]node_modules\/@bcp[\\/]/.test(moduleName)) ||
            ...
            minimizer: [
                new TerserPlugin({
                    ...
                    terserOptions: {
                        ...
                        mangle: {
                          properties: {
                            regex: /isRunningInEmulator|isDeviceRooted|isApplicationHooked|isApplicationTampered/
                          },
                        },
                    }
                })
        ...
        plugins: [
            ...
            new CopyWebpackPlugin([
                ...
                { from: { glob: "**/*.png" } },
                { from: { glob: "*.p12" } },
                { from: { glob: platform === 'android' ? 'licenses/*-android.lic' : 'licenses/*-ios.lic', } },
    ...
    if (jscrambler) {
        config.plugins.push(new JscramblerWebpack(Object.assign({}, jscramblerConfig, {
          chunks: ["bundle"]
        })));
    }
